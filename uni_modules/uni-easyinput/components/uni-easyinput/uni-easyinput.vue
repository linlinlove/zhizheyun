<template>
	<view class="uni-easyinput" :class="{'uni-easyinput-error':msg}" :style="boxStyle">
		...
		<view class="uni-easyinput__content" :class="inputContentClass" :style="inputContentStyle" v-if="type === 'textarea'"
		style="position: relative;">
				<textarea  class="uni-easyinput__content-textarea" 
					...
					:autoHeight="autoHeight" @input="onInput($event,1)" @blur="_Blur" @focus="_Focus" @confirm="onConfirm">
					</textarea>
					<text style="position: absolute;bottom: 0;right: 0;" >
						{{val.length?val.length:getSums}}/{{maxlength}}</text>
			</view>
